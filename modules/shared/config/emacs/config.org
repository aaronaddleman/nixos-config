...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/aaron/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/aaron/bin" "/profile/bin" "/Users/aaron/.npm-packages/bin" "/Users/aaron/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
